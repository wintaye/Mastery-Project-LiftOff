...
//
//        return args -> {
//            log.info("Preloading " + repository.save(new Tag("Skills I Have")));
//            log.info("Preloading " + repository.save(new Tag("Skills I Want")));
//            log.info("Preloading " + repository.save(new Tag("Skills I Can Share")));
